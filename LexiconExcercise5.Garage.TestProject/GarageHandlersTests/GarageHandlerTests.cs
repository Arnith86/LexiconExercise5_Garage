...
public class GarageHandlerTests
{
	...
	///// <summary>
	///// Create a initialized <see cref="GarageHandler"/>.
	///// </summary>
	///// <returns>A initialized <see cref="GarageHandler"/>.</returns>
	//public GarageHandler GarageHandlerCreator()
	//{
	//	ConsoleWritePrint consoleWritePrint = new();
	//	ConsoleUI consoleUI = new(consoleWritePrint);

	//	return new GarageHandler(consoleWritePrint, consoleUI);
	//}
}
