namespace LexiconExercise5_Garage.Vehicles.VehicleFactories
{
	...
	public interface IVehicleFactory
	{
		...
		/// <returns>A new <see cref="VehicleBase"/> instance representing an airplane.</returns>
		VehicleBase CreateAirPlain(
		...
		/// <returns>A new <see cref="VehicleBase"/> instance representing a boat.</returns>
		VehicleBase CreateBoat(
			Func<string, bool> licensePlateValidator,
			string licensePlate,
			VehicleColor color,
			uint wheels,
		...
		/// <returns>A new <see cref="VehicleBase"/> instance representing a bus.</returns>
		VehicleBase CreateBus(
			Func<string, bool> licensePlateValidator,
			string licensePlate,
			VehicleColor color,
			uint wheels,
		...
		/// <returns>A new <see cref="VehicleBase"/> instance representing a car.</returns>
		VehicleBase CreateCar(
			Func<string, bool> licensePlateValidator,
			string licensePlate,
			VehicleColor color,
			uint wheels,
		...
		/// <returns>A new <see cref="VehicleBase"/> instance representing a motorcycle.</returns>
		VehicleBase CreateMotorcycle(
			Func<string, bool> licensePlateValidator,
			string licensePlate,
			VehicleColor color,
			uint wheels,
