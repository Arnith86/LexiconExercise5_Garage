...
namespace LexiconExercise5_Garage.Vehicles.VehicleFactories
{
	...
	public interface IVehicleFactory
	{
		...
		/// <returns>A new <see cref="IVehicle"/> instance representing an airplane.</returns>
		IVehicle CreateAirPlain(
		...
		/// <returns>A new <see cref="IVehicle"/> instance representing a boat.</returns>
		IVehicle CreateBoat(
			Func<string, bool> licensePlateValidator,
			string licensePlate,
			VehicleColor color,
		...
		/// <returns>A new <see cref="IVehicle"/> instance representing a bus.</returns>
		IVehicle CreateBus(
			Func<string, bool> licensePlateValidator,
			string licensePlate,
			VehicleColor color,
		...
		/// <returns>A new <see cref="IVehicle"/> instance representing a car.</returns>
		IVehicle CreateCar(
			Func<string, bool> licensePlateValidator,
			string licensePlate,
			VehicleColor color,
		...
		/// <returns>A new <see cref="IVehicle"/> instance representing a motorcycle.</returns>
